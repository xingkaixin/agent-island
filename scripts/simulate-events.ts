...
const legacySingleScenarios: Record<string, EventSpec[]> = {
  claude: [
    ...claudeRunning("claude-demo"),
    ...claudePermission("claude-demo"),
  ],
  codex: [
    ...codexRunning("codex-demo"),
    stopSession("codex", "codex-demo"),
  ],
  cursor: [
    ...cursorRunning("cursor-demo"),
...
function buildMixedPermissionScenario() {
  return [
    ...buildMixedRunningScenario(),
    ...codexPermission("codex-demo-1"),
  ];
}
